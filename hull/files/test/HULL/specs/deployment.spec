...
* Test Object has key "spec§template§spec§containers§0§env§0§value" with value "release-name-hull-test-myapp-server"
* Test Object has key "spec§template§spec§containers§0§env§1§value" with value "8080"
* Set test object to "release-name-hull-test-myapp-server"
* Test Object has key "spec§template§spec§containers§0§image" with value "mycompany/myapp-server:v23.1"
...
* Test Object has key "spec§template§spec§containers§0§volumeMounts§0§subPath" with value "server-appconfig.json"
...
* Test Object has key "data§server-appconfig.json" with value containing "\"rate-limit\": 100"
* Test Object has key "data§server-appconfig.json" with value containing "\"max-connections\": 5"
* Test Object has key "data§server-appconfig.json" with value containing "\"debug-log\": true"
...
* Set test object to "release-name-hull-test-myapp-server" of kind "Service"
...
* Test Object has key "data§server-appconfig.json" with value containing "\"rate-limit\": 100"
* Test Object has key "data§server-appconfig.json" with value containing "\"max-connections\": 5"
* Test Object has key "data§server-appconfig.json" with value not containing "\"debug-log\": true"
* Set test object to "release-name-hull-test-myapp-frontend" of kind "Service"
* Test Object has key "spec§type" with value "ClusterIP"
* Test Object has key "spec§ports§0§port" with integer value "80"
* Test Object has key "spec§ports§0§targetPort" with value "http"
