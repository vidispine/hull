...
## Render and Validate
* Lint and Render
* Expected number of "23" objects were rendered on top of basic objects count
* Validate
...
* Fail to render the templates for additional values file "values_undefined.hull.yaml" to test execution folder because error contains "HULL failed with error (@Values.hull.objects.configmap.test-get-undefined-variants.data.bool_undefined.inline) Element bool_undefined in path hull.config.specific.bool_undefined was not found"
* Fail to render the templates for additional values file "values_undefined.hull.yaml" to test execution folder because error contains "HULL failed with error (@Values.hull.objects.configmap.test-get-undefined-variants.data.number_undefined.inline) Element number_undefined in path hull.config.specific.number_undefined was not found"
* Fail to render the templates for additional values file "values_undefined.hull.yaml" to test execution folder because error contains "HULL failed with error (@Values.hull.objects.configmap.test-get-undefined-variants.data.string_undefined.inline) Element string_undefined in path hull.config.specific.string_undefined was not found"
* End Tests for specific Helm version
...
## Debug options
* Fail to render the templates for values file "values_broken_get_references.hull.yaml" to test execution folder because error contains "HULL failed with error (@Values.hull.objects.configmap.broken-leaf-reference.labels.test) Element value_to_resolve_3 in path hull.config.specific.value_to_resolve_3 was not found"
...
* Fail to render the templates for values file "values_error_handling_missing_path.hull.yaml" to test execution folder because error contains "HULL failed with error (@Values.hull.objects.configmap.virtual-folder-path-invalid.data.invalid.path) Path files/nothing-here does not exist"
...
* Fail to render the templates for values file "values_error_handling_invalid_inline.hull.yaml" to test execution folder because error contains "HULL failed with error (@Values.hull.objects.configmap.virtual-folder-inline-invalid.data.invalid.inline) Inline data is invalid"
...
* Fail to render the templates for values file "values_error_handling_null_inline.hull.yaml" to test execution folder because error contains "HULL failed with error (@Values.hull.objects.configmap.virtual-folder-inline-null.data.nothing.inline) Inline data is invalid"
