...
| `resourcequota` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName` | [**resourcequotaspec-v1-core**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#resourcequotaspec-v1-core)<br>`hard`<br>`scopeSelector`<br>`scopes` |
| `secret` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName`<br><br>[**hull.VirtualFolder.v1**](/hull/files/doc/API/hull_objects_configmaps_secrets.md)<br>`data` | [**secret-v1-core**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#secret-v1-core)<br>`immutable`<br>`stringData`<br>`type` |
...
| `serviceaccount` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName` | [**serviceaccount-v1-core**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#serviceaccount-v1-core)<br>`automountServiceAccountToken`<br>`imagePullSecrets`<br>`secrets` |

### **[Discovery APIs](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#discovery)**

| HULL<br> Object Type | HULL <br>Properties | Kubernetes/External<br> Properties |
| -------------------- | ------------------- | ---------------------------------- |
| `endpointslice` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName` | [**endpointslice-v1-discovery-k8s-io**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#endpointslice-v1-discovery-k8s-io)<br>`addressType`<br>`endpoints`<br>`ports` |

### **[Networking APIs](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#networking)**

| HULL<br> Object Type | HULL <br>Properties | Kubernetes/External<br> Properties |
| -------------------- | ------------------- | ---------------------------------- |
| `ingress` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName`<br><br>[**hull.Ingress.v1**](/hull/files/doc/API/hull_objects_ingress.md)<br>`tls`<br>`rules` | [**ingressspec-v1-networking-k8s-io**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#ingressspec-v1-networking-k8s-io)<br>`defaultBackend`<br>`ingressClassName` |
| `ingressclass` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName` | [**ingressclassspec-v1-networking-k8s-io**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#ingressclassspec-v1-networking-k8s-io)<br>`controller`<br>`parameters` |
| `networkpolicy` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName` | [**networkpolicyspec-v1-networking-k8s-io**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#networkpolicyspec-v1-networking-k8s-io)<br>`egress`<br>`ingress`<br>`podSelector`<br>`policyTypes` |

### **[Policy APIs](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#policy)**

| HULL<br> Object Type | HULL <br>Properties | Kubernetes/External<br> Properties |
| -------------------- | ------------------- | ---------------------------------- |
| `poddisruptionbudget` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName` | [**poddisruptionbudgetspec-v1-policy**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#poddisruptionbudgetspec-v1-policy)<br>`maxUnavailable`<br>`minAvailable`<br>`selector`<br>`unhealthyPodEvictionPolicy` |

### **[RBAC APIs](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#rbac)**

| HULL<br> Object Type | HULL <br>Properties | Kubernetes/External<br> Properties |
| -------------------- | ------------------- | ---------------------------------- |
| `clusterrole` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName`<br><br>[**hull.Rule.v1**](/hull/files/doc/API/hull_objects_role.md)<br>`rules` | [**clusterrole-v1-rbac-authorization-k8s-io**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#clusterrole-v1-rbac-authorization-k8s-io)<br>`aggregationRule` |
| `clusterrolebinding` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName` | [**clusterrolebinding-v1-rbac-authorization-k8s-io**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#clusterrolebinding-v1-rbac-authorization-k8s-io)<br>`roleRef`<br>`subjects` |
| `role` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName`<br><br>[**hull.Rule.v1**](/hull/files/doc/API/hull_objects_role.md)<br>`rules` | [**role-v1-rbac-authorization-k8s-io**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#role-v1-rbac-authorization-k8s-io) |
| `rolebinding` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName` | [**rolebinding-v1-rbac-authorization-k8s-io**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#rolebinding-v1-rbac-authorization-k8s-io)<br>`roleRef`<br>`subjects` |

### **[Scheduling APIs](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#scheduling)**
...
### **[Storage APIs](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#storage)**

| HULL<br> Object Type | HULL <br>Properties | Kubernetes/External<br> Properties |
| -------------------- | ------------------- | ---------------------------------- |
| `storageclass` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName` | [**storageclass-v1-storage-k8s-io**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#storageclass-v1-storage-k8s-io)<br>`allowVolumeExpansion`<br>`allowedTopologies`<br>`mountOptions`<br>`parameters`<br>`provisioner`<br>`reclaimPolicy`<br>`volumeBindingMode` |
