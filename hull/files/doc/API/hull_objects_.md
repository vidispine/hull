...
### **[Admissionregistration APIs](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#admissionregistration)**

| HULL<br> Object Type<br> | HULL <br>Properties | Kubernetes/External<br> Properties |
| ------------------------ | ------------------- | ---------------------------------- |
| `mutatingadmissionpolicy` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName`<br><br>[**mutatingadmissionpolicyspec-v1-admissionregistration**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#mutatingadmissionpolicyspec-v1-admissionregistration-k8s-io)<br>`failurePolicy`<br>`matchConditions`<br>`matchConstraints`<br>`mutations`<br>`paramKind`<br>`reinvocationPolicy`<br>`variables` | |
| `mutatingadmissionpolicybinding` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName`<br><br>[**mutatingadmissionpolicybindingspec-v1-admissionregistration**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#mutatingadmissionpolicybindingspec-v1-admissionregistration-k8s-io)<br>`matchResources`<br>`paramRef`<br>`policyName` | |
...
| `validatingadmissionpolicy` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName`<br><br>[**validatingadmissionpolicyspec-v1-admissionregistration**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#validatingadmissionpolicyspec-v1-admissionregistration-k8s-io)<br>`auditAnnotations`<br>`failurePolicy`<br>`matchConditions`<br>`matchConstraints`<br>`paramKind`<br>`validations`<br>`variables` | |
| `validatingadmissionpolicybinding` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName`<br><br>[**validatingadmissionpolicybindingspec-v1-admissionregistration**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#validatingadmissionpolicybindingspec-v1-admissionregistration-k8s-io)<br>`matchResources`<br>`paramRef`<br>`policyName`<br>`validationActions` | |
...
### **[Apps APIs](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#apps)**

| HULL<br> Object Type<br> | HULL <br>Properties | Kubernetes/External<br> Properties |
| ------------------------ | ------------------- | ---------------------------------- |
| `daemonset` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName`<br><br>[**hull.PodTemplate.v1**](/hull/files/doc/API/hull_objects_pod.md)<br>`templateAnnotations`<br>`templateLabels`<br>`pod` | [**daemonsetspec-v1-apps**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#daemonsetspec-v1-apps)<br>`minReadySeconds`<br>`ordinals`<br>`revisionHistoryLimit`<br>`updateStrategy` |
| `deployment` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName`<br><br>[**hull.PodTemplate.v1**](/hull/files/doc/API/hull_objects_pod.md)<br>`templateAnnotations`<br>`templateLabels`<br>`pod` | [**deploymentspec-v1-apps**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#deploymentspec-v1-apps)<br>`minReadySeconds`<br>`paused`<br>`progressDeadlineSeconds`<br>`replicas`<br>`revisionHistoryLimit`<br>`strategy` |
| `statefulset` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName`<br><br>[**hull.PodTemplate.v1**](/hull/files/doc/API/hull_objects_pod.md)<br>`templateAnnotations`<br>`templateLabels`<br>`pod` | [**statefulsetspec-v1-apps**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#statefulsetspec-v1-apps)<br>`podManagementPolicy`<br>`replicas`<br>`revisionHistoryLimit`<br>`serviceName`<br>`updateStrategy`<br>`serviceName`<br>`volumeClaimTemplates` |

### **[Autoscaling APIs](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#autoscaling)**

| HULL<br> Object Type<br> | HULL <br>Properties | Kubernetes/External<br> Properties |
| ------------------------ | ------------------- | ---------------------------------- |
| `horizontalpodautoscaler` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName`<br><br>[**hull.HorizontalPodAutoscaler.v1**](/hull/files/doc/API/hull_objects_horizontalpodautoscaler.md)<br>`scaleTargetRef` | [**horizontalpodautoscalerspec-v2-autoscaling**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#horizontalpodautoscalerspec-v2-autoscaling)<br>`behavior`<br>`maxReplicas`<br>`metrics`<br>`minReplicas` |

### **[Batch APIs](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#batch)**

| HULL<br> Object Type<br> | HULL <br>Properties | Kubernetes/External<br> Properties |
| ------------------------ | ------------------- | ---------------------------------- |
| `job` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName`<br><br>[**hull.PodTemplate.v1**](/hull/files/doc/API/hull_objects_pod.md)<br>`templateAnnotations`<br>`templateLabels`<br>`pod` | [**jobspec-v1-batch**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#jobspec-v1-batch)<br>`activeDeadlineSeconds`<br>`backoffLimit`<br>`completionMode`<br>`completions`<br>`manualSelector`<br>`parallelism`<br>`selector`<br>`suspend`<br>`ttlSecondsAfterFinished` |
| `cronjob` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName`<br><br>[**hull.Job.v1**](./README.md)<br>`job` | [**cronjobspec-v1-batch**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#cronjobspec-v1-batch)<br>`concurrencyPolicy`<br>`failedJobsHistoryLimit`<br>`schedule`<br>`startingDeadlineSeconds`<br>`successfulJobsHistoryLimit`<br>`suspend` |

### **[Core APIs](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#core)**

| HULL<br> Object Type<br> | HULL <br>Properties | Kubernetes/External<br> Properties |
| ------------------------ | ------------------- | ---------------------------------- |
| `configmap` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName`<br><br>[**hull.VirtualFolder.v1**](/hull/files/doc/API/hull_objects_configmaps_secrets.md)<br>`data` | [**configmap-v1-core**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#configmap-v1-core)<br>`binaryData`<br>`immutable` |
| `endpoints`<br>(deprecated<br>since<br>K8S 1.33) | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName` | [**endpoints-v1-core**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#endpoints-v1-core)<br>`subsets` |
| `limitrange` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName` | [**limitrange-v1-core**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#limitrange-v1-core)<br>`limits` |
| `namespace` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName` | [**namespace-v1-core**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#namespace-v1-core)<br>`spec`<br>`status` |
| `persistentvolume` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName` | [**persistentvolumespec-v1-core**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#persistentvolumespec-v1-core)<br>`accessModes`<br>`awsElasticBlockStore`<br>`azureDisk`<br>`azureFile`<br>`capacity`<br>`cephfs`<br>`cinder`<br>`claimRef`<br>`csi`<br>`fc`<br>`flexVolume`<br>`flocker`<br>`gcePersistentDisk`<br>`glusterfs`<br>`hostPath`<br>`iscsi`<br>`local`<br>`mountOptions`<br>`nfs`<br>`nodeAffinity`<br>`persistentVolumeReclaimPolicy`<br>`photonPersistentDisk`<br>`portworxVolume`<br>`quobyte`<br>`rbd`<br>`scaleIO`<br>`storageClassName`<br>`storageos`<br>`volumeMode`<br>`vsphereVolume` |
| `persistentvolumeclaim` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName` | [**persistentvolumeclaimspec-v1-core**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#persistentvolumeclaimspec-v1-core)<br>`accessModes`<br>`dataSource`<br>`resources`<br>`selector`<br>`storageClassName`<br>`volumeMode`<br>`volumeName` |
| `resourcequota` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName` | [**resourcequotaspec-v1-core**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#resourcequotaspec-v1-core)<br>`hard`<br>`scopeSelector`<br>`scopes` |
| `secret` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName`<br><br>[**hull.VirtualFolder.v1**](/hull/files/doc/API/hull_objects_configmaps_secrets.md)<br>`data` | [**secret-v1-core**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#secret-v1-core)<br>`immutable`<br>`stringData`<br>`type` |
| `service` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName`<br><br>[**hull.Service.v1**](/hull/files/doc/API/hull_objects_service.md)<br>`ports` | [**servicespec-v1-core**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#servicespec-v1-core)<br>`allocateLoadBalancerNodePorts`<br>`clusterIP`<br>`clusterIPs`<br>`externalIPs`<br>`externalName`<br>`externalTrafficPolicy`<br>`healthCheckNodePort`<br>`internalTrafficPolicy`<br>`ipFamilies`<br>`ipFamilyPolicy`<br>`loadBalancerClass`<br>`loadBalancerIP`<br>`loadBalancerSourceRanges`<br>`publishNotReadyAddresses`<br>`selector`<br>`sessionAffinity`<br>`sessionAffinityConfig`<br>`topologyKeys`<br>`type` |
| `serviceaccount` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName` | [**serviceaccount-v1-core**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#serviceaccount-v1-core)<br>`automountServiceAccountToken`<br>`imagePullSecrets`<br>`secrets` |

### **[Discovery APIs](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#discovery)**

| HULL<br> Object Type | HULL <br>Properties | Kubernetes/External<br> Properties |
| -------------------- | ------------------- | ---------------------------------- |
| `endpointslice` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName` | [**endpointslice-v1-discovery-k8s-io**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#endpointslice-v1-discovery-k8s-io)<br>`addressType`<br>`endpoints`<br>`ports` |

### **[Networking APIs](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#networking)**

| HULL<br> Object Type | HULL <br>Properties | Kubernetes/External<br> Properties |
| -------------------- | ------------------- | ---------------------------------- |
| `ingress` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName`<br><br>[**hull.Ingress.v1**](/hull/files/doc/API/hull_objects_ingress.md)<br>`tls`<br>`rules` | [**ingressspec-v1-networking-k8s-io**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#ingressspec-v1-networking-k8s-io)<br>`defaultBackend`<br>`ingressClassName` |
| `ingressclass` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName` | [**ingressclassspec-v1-networking-k8s-io**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#ingressclassspec-v1-networking-k8s-io)<br>`controller`<br>`parameters` |
| `networkpolicy` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName` | [**networkpolicyspec-v1-networking-k8s-io**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#networkpolicyspec-v1-networking-k8s-io)<br>`egress`<br>`ingress`<br>`podSelector`<br>`policyTypes` |

### **[Policy APIs](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#policy)**

| HULL<br> Object Type | HULL <br>Properties | Kubernetes/External<br> Properties |
| -------------------- | ------------------- | ---------------------------------- |
| `poddisruptionbudget` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName` | [**poddisruptionbudgetspec-v1-policy**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#poddisruptionbudgetspec-v1-policy)<br>`maxUnavailable`<br>`minAvailable`<br>`selector`<br>`unhealthyPodEvictionPolicy` |

### **[RBAC APIs](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#rbac)**

| HULL<br> Object Type | HULL <br>Properties | Kubernetes/External<br> Properties |
| -------------------- | ------------------- | ---------------------------------- |
| `clusterrole` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName`<br><br>[**hull.Rule.v1**](/hull/files/doc/API/hull_objects_role.md)<br>`rules` | [**clusterrole-v1-rbac-authorization-k8s-io**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#clusterrole-v1-rbac-authorization-k8s-io)<br>`aggregationRule` |
| `clusterrolebinding` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName` | [**clusterrolebinding-v1-rbac-authorization-k8s-io**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#clusterrolebinding-v1-rbac-authorization-k8s-io)<br>`roleRef`<br>`subjects` |
| `role` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName`<br><br>[**hull.Rule.v1**](/hull/files/doc/API/hull_objects_role.md)<br>`rules` | [**role-v1-rbac-authorization-k8s-io**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#role-v1-rbac-authorization-k8s-io) |
| `rolebinding` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName` | [**rolebinding-v1-rbac-authorization-k8s-io**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#rolebinding-v1-rbac-authorization-k8s-io)<br>`roleRef`<br>`subjects` |

### **[Scheduling APIs](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#scheduling)**

| HULL<br> Object Type | HULL <br>Properties | Kubernetes/External<br> Properties |
| -------------------- | ------------------- | ---------------------------------- |
| `priorityclass` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName` | [**priorityclass-v1-scheduling-k8s-io**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#priorityclass-v1-scheduling-k8s-io)<br>`description`<br>`globalDefault`<br>`preemptionPolicy`<br>`value` |

### **[Storage APIs](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#storage)**

| HULL<br> Object Type | HULL <br>Properties | Kubernetes/External<br> Properties |
| -------------------- | ------------------- | ---------------------------------- |
| `storageclass` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName` | [**storageclass-v1-storage-k8s-io**](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#storageclass-v1-storage-k8s-io)<br>`allowVolumeExpansion`<br>`allowedTopologies`<br>`mountOptions`<br>`parameters`<br>`provisioner`<br>`reclaimPolicy`<br>`volumeBindingMode` |

### **HULL Extensions APIs**

| HULL<br> Object Type | HULL <br>Properties | Kubernetes/External<br> Properties |
| -------------------- | ------------------- | ---------------------------------- |
| `customresource` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName`<br><br>[**hull.CustomResource.v1**](/hull/files/doc/API/hull_objects_extensions.md)<br>`apiVersion`<br>`kind`<br>`spec` | |
| `generic` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName`<br><br>[**hull.Generic.v1**](/hull/files/doc/API/hull_objects_extensions.md)<br>`apiVersion`<br>`kind` | |
| `registry` | [**hull.ObjectBase.v1**](/hull/files/doc/API/hull_objects_base.md)<br>`enabled`<br>`annotations`<br>`labels`<br>`staticName`<br><br>[**hull.Registry.v1**](/hull/files/doc/API/hull_objects_extensions.md)<br>`server`<br>`username`<br>`password` | |
